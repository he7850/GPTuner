...
if __name__ == '__main__':
    ...
    target_knobs_path = f"/root/workspace/GPTuner/knowledge_collection/postgres/target_knobs.txt"
    ...
    knowledge_pre = KGPre(db=args.db, api_base="your_api_base", api_key="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", model="gpt-3.5")
    knowledge_trans = KGTrans(db=args.db, api_base="your_api_base", api_key="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", model="gpt-3.5")
